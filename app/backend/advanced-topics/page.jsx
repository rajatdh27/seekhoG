...
const GRPCSection = lazy(() => import("./components/sections/GRPCSection"));
const SearchEnginesSection = lazy(() => import("./components/sections/SearchEnginesSection"));
const RateLimitingSection = lazy(() => import("./components/sections/RateLimitingSection"));
const WebhookSystemsSection = lazy(() => import("./components/sections/WebhookSystemsSection"));
const FileStorageSection = lazy(() => import("./components/sections/FileStorageSection"));

const sections = [
  { id: "graphql", title: "GraphQL", component: GraphQLSection },
  { id: "grpc", title: "gRPC", component: GRPCSection },
  { id: "search-engines", title: "Search Engines", component: SearchEnginesSection },
  { id: "rate-limiting", title: "Rate Limiting", component: RateLimitingSection },
  { id: "webhook-systems", title: "Webhook Systems", component: WebhookSystemsSection },
  { id: "file-storage", title: "File Storage", component: FileStorageSection },
];
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold">Advanced Topics</h1>
          </motion.div>
          <motion.p
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            Master advanced backend technologies - GraphQL, gRPC, search engines, webhooks, and modern API patterns
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
