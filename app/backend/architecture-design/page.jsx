...
import MicroservicesSection from "./components/sections/MicroservicesSection";

// Lazy load other sections
const DesignPatternsSection = lazy(() => import("./components/sections/DesignPatternsSection"));
const CleanArchitectureSection = lazy(() => import("./components/sections/CleanArchitectureSection"));
const DomainDrivenDesignSection = lazy(() => import("./components/sections/DomainDrivenDesignSection"));

const sections = [
  { id: "microservices", title: "Microservices & Service Mesh", component: MicroservicesSection },
  { id: "design-patterns", title: "Design Patterns", component: DesignPatternsSection },
  { id: "clean-architecture", title: "Clean Architecture", component: CleanArchitectureSection },
  { id: "domain-driven-design", title: "Domain-Driven Design", component: DomainDrivenDesignSection },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 dark:from-emerald-700 dark:via-teal-800 dark:to-cyan-700 text-white py-16 px-6"
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold">Architecture & Design</h1>
          </motion.div>
          <motion.p
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            Master microservices, design patterns, clean architecture, and domain-driven design for scalable systems!
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
