...
const MetricsMonitoringSection = lazy(() => import("./components/sections/MetricsMonitoringSection"));
const DistributedTracingSection = lazy(() => import("./components/sections/DistributedTracingSection"));
const ErrorTrackingSection = lazy(() => import("./components/sections/ErrorTrackingSection"));
const AlertingSection = lazy(() => import("./components/sections/AlertingSection"));

const sections = [
  { id: "logging", title: "Logging", component: LoggingSection },
  { id: "metrics-monitoring", title: "Metrics & Monitoring", component: MetricsMonitoringSection },
  { id: "distributed-tracing", title: "Distributed Tracing", component: DistributedTracingSection },
  { id: "error-tracking", title: "Error Tracking", component: ErrorTrackingSection },
  { id: "alerting", title: "Alerting", component: AlertingSection },
];
...
export default function ObservabilityPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
      {/* Hero Section */}
      <motion.div
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        className="bg-gradient-to-r from-purple-600 via-indigo-600 to-violet-600 dark:from-purple-700 dark:via-indigo-800 dark:to-violet-700 text-white py-16 px-6"
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold">Observability</h1>
          </motion.div>
          <motion.p
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            Master logging, monitoring, tracing, and alerting to understand and debug your distributed systems
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
