...
import GreedyIntro from "./components/sections/GreedyIntro";
...
const sections = [
  { id: "intro", title: "Introduction", component: GreedyIntro, icon: Gem },
  { id: "activity", title: "Activity Selection", component: ActivitySelection, icon: CalendarClock },
  { id: "knapsack", title: "Fractional Knapsack", component: FractionalKnapsack, icon: ShoppingBag },
  { id: "huffman", title: "Huffman Coding", component: HuffmanCoding, icon: TreeDeciduous },
  { id: "patterns", title: "Greedy Patterns", component: GreedyPatterns, icon: Layers },
  { id: "cheatsheet", title: "Cheatsheet", component: GreedyCheatsheet, icon: FileText },
];
...
export default function GreedyPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100 selection:bg-violet-500/30">
      {/* Scroll Progress Bar */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-violet-500 to-purple-500 z-[100] origin-left"
        style={{ scaleX }}
      />
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <Gem size={14} className="fill-violet-400" /> Optimal Choices
          </motion.div>
          ...
          >
            <div className="text-8xl filter drop-shadow-[0_0_15px_rgba(139,92,246,0.3)] animate-bounce">💎</div>
          ...
          >
            Make locally optimal choices at each step to find the global optimum. Fast, efficient, and powerful.
          </motion.p>
          ...
          >
            <a
              href="#intro"
              className="px-10 py-5 bg-violet-600 hover:bg-violet-500 text-white rounded-2xl font-black text-lg transition-all shadow-2xl shadow-violet-600/20 active:scale-95"
            >
              Start Learning
            </a>
            <a
