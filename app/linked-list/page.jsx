...
const sections = [
  { id: "intro", title: "What is a Linked List?", component: LinkedListIntro, icon: LinkIcon },
  { id: "memory", title: "Memory & Implementation", component: LinkedListMemoryLayout, icon: Cpu },
  { id: "syntax", title: "Syntax Across Languages", component: LinkedListSyntax, icon: Code2 },
  { id: "complexity", title: "Time & Space Complexity", component: LinkedListComplexity, icon: Zap },
  { id: "patterns", title: "Interview Patterns", component: LinkedListPatterns, icon: Grid },
  { id: "problems", title: "Must-Know Problems", component: LinkedListProblems, icon: Trophy },
  { id: "applications", title: "Real-World Applications", component: LinkedListApplications, icon: Layout },
  { id: "cheatsheet", title: "Cheatsheet", component: LinkedListCheatsheet, icon: FileText },
];
...
export default function LinkedListPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100 selection:bg-emerald-500/30">
      {/* Scroll Progress Bar */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-emerald-500 to-teal-500 z-[100] origin-left"
        style={{ scaleX }}
      />
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <LinkIcon size={14} className="fill-emerald-400" /> Dynamic Connectivity
          </motion.div>
          ...
          >
            <div className="text-8xl filter drop-shadow-[0_0_15px_rgba(16,185,129,0.3)] animate-bounce">🔗</div>
          ...
          >
            Master node fundamentals, pointer arithmetic, and advanced algorithmic patterns like Fast & Slow pointers.
          </motion.p>
          ...
          >
            <a
              href="#intro"
              className="px-10 py-5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl font-black text-lg transition-all shadow-2xl shadow-emerald-600/20 active:scale-95"
            >
              Start Learning
            </a>
            <a
