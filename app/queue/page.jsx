...
const QueueImplementation = lazy(() => import("./components/sections/QueueImplementation"));
const QueuePatterns = lazy(() => import("./components/sections/QueuePatterns"));
const QueueApplications = lazy(() => import("./components/sections/QueueApplications"));
const QueueCheatsheet = lazy(() => import("./components/sections/QueueCheatsheet"));

const sections = [
  { id: "intro", title: "What is a Queue?", component: QueueIntro, icon: ChevronsRight },
  { id: "implementation", title: "Implementation", component: QueueImplementation, icon: CircuitBoard },
  { id: "patterns", title: "Queue Patterns", component: QueuePatterns, icon: Star },
  { id: "applications", title: "Applications", component: QueueApplications, icon: Code2 },
  { id: "cheatsheet", title: "Cheatsheet", component: QueueCheatsheet, icon: FileText },
];
...
export default function QueuePage() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100 selection:bg-green-500/30">
      {/* Scroll Progress Bar */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-green-500 to-emerald-500 z-[100] origin-left"
        style={{ scaleX }}
      />
      ...
      <div className="fixed inset-0 z-0 opacity-20 pointer-events-none">
        ...
        <div className="absolute top-0 left-0 right-0 h-[500px] bg-gradient-to-b from-green-600/20 to-transparent blur-[120px]" />
      </div>
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <ChevronsRight size={14} className="fill-green-400" /> First-In, First-Out
          </motion.div>
          ...
          >
            <div className="text-8xl filter drop-shadow-[0_0_15px_rgba(16,185,129,0.3)] animate-bounce">🎟️</div>
          ...
          >
            Explore the FIFO principle, from simple queues to priority queues and deques. Essential for managing tasks, data streams, and more.
          </motion.p>
          ...
          >
            <a
              href="#intro"
              className="px-10 py-5 bg-green-600 hover:bg-green-500 text-white rounded-2xl font-black text-lg transition-all shadow-2xl shadow-green-600/20 active:scale-95"
            >
              Start Learning
            </a>
            <a
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4 mb-8 group">
                    <div className="w-12 h-12 bg-green-500/10 rounded-xl flex items-center justify-center text-green-400 border border-green-500/20 group-hover:scale-110 transition-transform">
                      <Icon size={24} />
                    </div>
