...
const CircularQueue = lazy(() => import("./components/sections/CircularQueue"));
const PriorityQueue = lazy(() => import("./components/sections/PriorityQueue"));
const DequeSection = lazy(() => import("./components/sections/DequeSection"));
...
const sections = [
  { id: "intro", title: "Introduction", component: QueueIntro },
  { id: "implementation", title: "Queue Implementation", component: QueueImplementation },
  { id: "circular", title: "Circular Queue", component: CircularQueue },
  { id: "priority", title: "Priority Queue", component: PriorityQueue },
  { id: "deque", title: "Double-Ended Queue (Deque)", component: DequeSection },
...
export default function QueuePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-amber-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
      {/* Hero Section */}
      <motion.div
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        className="bg-gradient-to-r from-orange-600 to-amber-600 dark:from-orange-700 dark:to-amber-800 text-white py-16 px-6"
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold">Queue</h1>
          </motion.div>
          <motion.p
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            Master Queue data structure - FIFO principle, circular queues, priority queues, and deques!
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
