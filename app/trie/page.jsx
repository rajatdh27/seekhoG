...
const sections = [
  { id: "intro", title: "Introduction", component: TrieIntro, icon: Library },
  { id: "operations", title: "Trie Operations", component: TrieOperationsSection, icon: GitBranch },
  { id: "implementation", title: "Implementation", component: TrieImplementationSection, icon: Code2 },
  { id: "applications", title: "Applications", component: TrieApplicationsSection, icon: Search },
  { id: "patterns", title: "Common Patterns", component: TriePatternsSection, icon: Grid },
  { id: "cheatsheet", title: "Cheatsheet", component: TrieCheatsheet, icon: FileText },
];
    ...
    <div className="min-h-screen bg-[#020617] text-slate-100 selection:bg-orange-500/30">
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <Library size={14} className="fill-orange-400" /> Prefix Trees
          </motion.div>
          ...
          >
            <div className="text-8xl filter drop-shadow-[0_0_15px_rgba(249,115,22,0.3)] animate-bounce">🗂️</div>
          ...
          >
            Master the ultimate data structure for autocomplete, spell checking, and string matching.
          </motion.p>
