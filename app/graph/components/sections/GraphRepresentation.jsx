...
matrix := [][]int{
  ...
  const representations = [
    {
      ...
      description: "Each vertex stores a list of connected neighbors. Ideally implemented with a Map or Array of Lists.",
      icon: List,
      color: "cyan",
      footer: (
    ...
    },
    {
      ...
      description: "A 2D array where matrix[i][j] represents an edge from i to j. 1 means connected, 0 means not.",
      icon: Grid,
      color: "blue",
      footer: (
        <div className="space-y-6">
  ...
  return (
    <PerspectiveCard color="cyan">
      ...
      <ConceptGrid items={representations} columns={2} className="mb-12" />
