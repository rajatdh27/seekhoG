...
func dfsIterative(graph map[int][]int, start int) {
  ...
  const strategy = [
    {
      title: "The Strategy",
      description: "Explore as far as possible along each branch before backtracking. Behaves like exploring a maze—follow a path until a dead end, then go back.",
      icon: Layers,
      color: "purple",
      footer: (
        <div className="grid grid-cols-3 gap-2 font-mono text-[9px] text-slate-300">
          <div className="bg-slate-950 p-2 rounded border border-white/5 flex flex-col items-center">
            <span className="text-slate-500 uppercase">Stack</span>
            <span className="text-purple-400 font-bold uppercase">LIFO</span>
          </div>
