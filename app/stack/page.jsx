...
const sections = [
  { id: "intro", title: "What is a Stack?", component: StackIntro, icon: Layers },
  { id: "memory", title: "Memory & Implementation", component: StackMemoryLayout, icon: Cpu },
  { id: "syntax", title: "Syntax Across Languages", component: StackSyntax, icon: Code2 },
  { id: "complexity", title: "Time & Space Complexity", component: StackComplexity, icon: Zap },
  { id: "patterns", title: "Interview Patterns", component: StackPatterns, icon: Grid },
  { id: "problems", title: "Must-Know Problems", component: StackProblems, icon: Trophy },
  { id: "applications", title: "Real-World Applications", component: StackApplications, icon: Layout },
  { id: "cheatsheet", title: "Cheatsheet", component: StackCheatsheet, icon: FileText },
];
    ...
    <div className="min-h-screen bg-[#020617] text-slate-100 selection:bg-purple-500/30">
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <Layers size={14} className="fill-purple-400" /> Last-In, First-Out
          </motion.div>
          ...
          >
            <div className="text-8xl filter drop-shadow-[0_0_15px_rgba(192,132,252,0.3)] animate-bounce">📚</div>
          ...
          >
            Master the LIFO principle, from call stacks to parsing expressions. Unlock powerful solutions with this fundamental data structure.
          </motion.p>
          ...
          >
            <a
              href="#intro"
              className="px-10 py-5 bg-purple-600 hover:bg-purple-500 text-white rounded-2xl font-black text-lg transition-all shadow-2xl shadow-purple-600/20 active:scale-95"
            >
              Start Learning
            </a>
            <a
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4 mb-8 group">
                    <div className="w-12 h-12 bg-purple-500/10 rounded-xl flex items-center justify-center text-purple-400 border border-purple-500/20 group-hover:scale-110 transition-transform">
                      <Icon size={24} />
                    </div>
