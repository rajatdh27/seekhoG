...
export default function TableOfContents({ sections, activeSection, onSectionClick }) {
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-700 dark:to-pink-800 p-4">
              ...
              <a
                ...
                className={`block px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                  activeSection === section.id
                    ? "bg-purple-100 dark:bg-purple-900/30 text-purple-900 dark:text-purple-200 border-l-4 border-purple-600"
