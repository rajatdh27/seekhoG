...
const dataStructures = [
  ...
  },
  {
    ...
    description: "Make locally optimal choices - activity selection, knapsack, Huffman coding",
    stats: { patterns: "6+", sections: "6+", problems: "10+" },
    features: ["Interactive Coin Demo", "All 6 Languages", "Classic Problems"],
    available: true,
  },
  {
    id: "backtracking",
    ...
    description: "N-Queens, Sudoku, subsets, and permutations with interactive visualizations",
    stats: { sections: "6+", patterns: "6+", problems: "8+" },
    features: ["Interactive Maze Solver", "All 6 Languages", "N-Queens & Sudoku"],
    available: true,
  },
  {
    id: "trie",
